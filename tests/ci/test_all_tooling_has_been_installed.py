...
def test_codespell_has_been_installed():
    """Test for the tool `codespell`"""
    assert (shutil.which('codespell')) is not None, "Run pip install in your virtual environment"  # noqa: 501 pylint: disable=line-too-long
